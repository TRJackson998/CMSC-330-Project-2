...
by returning the value of the first subexpression raised to the power of the second. This is
accomplished using the standard math library's pow() function
*/
